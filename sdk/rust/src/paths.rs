...
pub const APP_USER_TOTP_ENROLL: &str = concatcp!(APP_USER, "/totp/enroll");
pub const APP_USER_TOTP_VERIFY: &str = concatcp!(APP_USER, "/totp/verify");
pub const APP_USER_TOTP: &str = concatcp!(APP_USER, "/totp");
