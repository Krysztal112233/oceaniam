        ...
        <div class="modal-box w-11/12 max-w-lg">
            ...
            <form class="mt-4 space-y-4" @submit.prevent="handleSubmit">
                <label class="form-control w-full">
                    ...
                    <select v-model="selectedApplicationId" class="select select-bordered w-full"
                ...
                <label class="form-control w-full">
                    ...
                    <input v-model="password" type="password" class="input input-bordered w-full" placeholder="请输入用户密码"
                        :disabled="loading" />
                </label>
                ...
                <label class="form-control w-full">
                    ...
                    <input v-model="email" type="email" class="input input-bordered w-full"
                        placeholder="可选，邮箱和手机号至少填写一个" :disabled="loading" />
                </label>
                ...
                <label class="form-control w-full">
                    ...
                    <input v-model="phone" type="text" class="input input-bordered w-full" placeholder="可选，邮箱和手机号至少填写一个"
                        :disabled="loading" />
                </label>

                <div v-if="localValidationError || error" class="alert alert-error alert-soft">
